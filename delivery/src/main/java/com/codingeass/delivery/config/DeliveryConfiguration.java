package com.codingeass.delivery.config;
...
@Configuration
@ComponentScan("com.codingeass.delivery")
public class DeliveryConfiguration {
    ...
    public ConsumerFactory<String, Object> consumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, OrderDelivery.class.getCanonicalName());
